...
public class UploadModel extends TransferModel {
    ...
    private String stAWSAccessKeyId=null;

    public UploadModel(Context context, Uri uri, TransferManager manager,final String stBucketName,
          final String stAWSAccessKeyId) {
        super(context, uri, manager);
        mStatus = Status.IN_PROGRESS;
        this.stBucketName=stBucketName;
        this.stAWSAccessKeyId=stAWSAccessKeyId;
    ...
    public Upload upload() {
        ...
        if (mFile != null) {
               ...
               final TransferManager tx =getTransferManager();
                mUpload = tx.upload(
                         stBucketName.toLowerCase(Locale.US),
                        getPrefix() + super.getFileName() + "."
                                + mExtension,
                        mFile);
