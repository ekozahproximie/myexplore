...
import com.qualcomm.vuforia.samples.OcclusionManagement.ui.SampleAppMenu.SampleAppMenu;
import com.qualcomm.vuforia.samples.OcclusionManagement.ui.SampleAppMenu.SampleAppMenuGroup;
import com.qualcomm.vuforia.samples.OcclusionManagement.ui.SampleAppMenu.SampleAppMenuInterface;
...
// The main activity for the OcclusionManagement sample.
public class OcclusionManagement extends Activity implements
    SampleApplicationControl, SampleAppMenuInterface
{
    private static final String LOGTAG = "OcclusionManagement";
    ...
    // Our renderer:
    private OcclusionManagementRenderer mRenderer;
    ...
    {
        mTextures.add(Texture.loadTextureFromApk("OcclusionMgt/background.png",
            getAssets()));
        mTextures.add(Texture.loadTextureFromApk("OcclusionMgt/teapot.png",
            getAssets()));
        mTextures.add(Texture.loadTextureFromApk("OcclusionMgt/mask.png",
            getAssets()));
    }
    ...
    private void initApplicationAR()
    {
        ...
        mRenderer = new OcclusionManagementRenderer(this, vuforiaAppSession);
    ...
    void initMIT()
    {
        ...
        // server
        // using the original images provided in the sample's media folder, use
        // the
        // following trackable sizes on creation to get identical visual
        // results:
        ...
        {
            if (dataSet.getTrackable(i).getType() == MultiTarget.getClassType())
            {
    ...
    ImageTarget findImageTarget(String name)
    {
        ...
        if (imageTracker != null)
        {
            for (int i = 0; i < dataSet.getNumTrackables(); i++)
            {
                if (dataSet.getTrackable(i).getType() == ImageTracker
                    .getClassType())
                {
    ...
    {
        Log.d(LOGTAG, "MultiTargets.doLoadTrackersData");
        ...
        // Load the data set:
        if (!dataSet.load("OcclusionMgt/FlakesBox.xml",
    ...
    public void onInitARDone(SampleApplicationException exception)
    {
        ...
        if (exception == null)
        {
            ...
            mSampleAppMenu = new SampleAppMenu(this, this, "Occlusion Management",
