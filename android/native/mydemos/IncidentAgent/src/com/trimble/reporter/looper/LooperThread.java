...
public class LooperThread extends Thread {
    ...
    public static final String HEART_BEAT_URL="https://hydrogen.myconnectedsite.com/app/tcc/irtcc/actions/HeartBeat?lat=%s&lon=%s&deviceId=%s&ticket=";
    ...
    public static final String GET_INCIDENT="https://hydrogen.myconnectedsite.com/app/tcc/irtcc/actions/GetIncident?deviceId=%s&incidentId=%s&ticket=";
    
   public static final String ACQUIREINCIDENT ="https://hydrogen.myconnectedsite.com/app/tcc/irtcc/actions/AcquireIncident?deviceId=%s&incidentId=%s&";
   
   public static final String RESOLVEINCIDENT ="https://hydrogen.myconnectedsite.com/app/tcc/irtcc/actions/ResolveIncident?deviceId=%s&incidentId=%s&resolveComment=%s&";
    ...
    private TCCApplication mApplication =null;
            ...
            try {
                ...
                if (dataSend != null) {
                    try {
                        ...
                        dataSend.stURL=dataSend.stURL+""+stToken;
                        byte []bRespose=connectHttp(dataSend.stURL, null, null, dataSend.isPost, null, true,null);
                        Log.i(LOG, "Response ="+ new String(bRespose));
                        
                        
                        
                       String stActiveRequestId=null;
                        try {
                            JSONObject responseObject= new JSONObject(new String(bRespose)); 
                            
                            stActiveRequestId = responseObject.getString("activeRequestId");
                            mApplication.postMeg(stActiveRequestId);
                        } catch (JSONException e) {
    ...
    public void setTCCApplication(TCCApplication application){
