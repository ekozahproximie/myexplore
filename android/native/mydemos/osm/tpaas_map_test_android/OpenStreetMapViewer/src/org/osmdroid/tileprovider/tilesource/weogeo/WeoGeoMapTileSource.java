...
// ALK Map REST services return png images
   ...
   private static final String[] M_IMAGERYSET         = { "road",
...
// baseURl used for OnlineTileSourceBase override
   ...
   public WeoGeoMapTileSource(String aName, ResourceProxy.string aResourceId,
...
// setMapKey(appContext, aBaseUrl);
   ...
   public WeoGeoMapTileSource(String[] aBaseUrl, Context context,final int iStyle) {

      super(MAP_NAME,iStyle == ROAD ? ResourceProxy.string.weogeo:
