...
public interface ResourceProxy {
	...
	public static enum string {
		...
		// tile sources
		osmarender,mapnik, cyclemap, public_transport, base, topo, hills, cloudmade_small, cloudmade_standard, mapquest_osm, mapquest_aerial, bing,alk,

		// overlays
		fiets_nl, base_nl, roads_nl,alkroad,alkaerial,tpaas,weogeo,hweogeo,mapbox,
