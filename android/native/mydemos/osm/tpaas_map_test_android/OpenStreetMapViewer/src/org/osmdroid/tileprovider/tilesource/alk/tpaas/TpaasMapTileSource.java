package org.osmdroid.tileprovider.tilesource.alk.tpaas;
...
// baseURl used for OnlineTileSourceBase override
   ...
   private Integer               m_style              = AERIAL;

   public TpaasMapTileSource(String aName, ResourceProxy.string aResourceId,
...
// setMapKey(appContext, aBaseUrl);
   ...
   public TpaasMapTileSource(String[] aBaseUrl, Context context,final int iStyle) {

      super(MAP_NAME,iStyle == AERIAL ? ResourceProxy.string.tpaas:
...
// mode has been change, url pattern resolution should be updated
   ...
   public  synchronized void initMetaData() throws Exception
   {
           ...
           head.addHeader("Authorization" , "Bearer 5799a1f046a73b91782ecdf440887aff");
