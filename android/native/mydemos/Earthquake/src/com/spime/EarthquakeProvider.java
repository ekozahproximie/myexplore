...
public class EarthquakeProvider extends ContentProvider {
	...
	static {
		...
		uriMatcher.addURI("com.spime.provider.Earthquake", "earthquakes",
				QUAKES);
		uriMatcher.addURI("com.spime.provider.Earthquake", "earthquakes/#",
				QUAKE_ID);
	...
	.parse("content://com.spime.provider.earthquake/earthquakes");;
	...
	public String getType(Uri uri) {
		...
		case QUAKES:
			return "vnd.android.cursor.dir/vnd.spime.earthquake";
		case QUAKE_ID:
			return "vnd.android.cursor.item/vnd.spime.earthquake";
		default:
