...
public class PeopleDao extends AbstractDao<People, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property EpaNum = new Property(1, String.class, "epaNum", false, "EPA_NUM");
    ...
    protected void bindValues(SQLiteStatement stmt, People entity) {
        ...
        String epaNum = entity.getEpaNum();
        if (epaNum != null) {
            stmt.bindString(2, epaNum);
        }
    ...
    public People readEntity(Cursor cursor, int offset) {
        People entity = new People( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // epaNum
    ...
    public void readEntity(Cursor cursor, People entity, int offset) {
        ...
        entity.setEpaNum(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
