...
public class PickListDao extends AbstractDao<PickList, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property AttrinfoId = new Property(4, Long.class, "attrinfoId", false, "ATTRINFO_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'PICK_LIST' (" + //
                ...
                "'ATTRINFO_ID' INTEGER);"); // 4: attrinfoId
    }
    ...
    protected void bindValues(SQLiteStatement stmt, PickList entity) {
        ...
        Long attrinfoId = entity.getAttrinfoId();
        if (attrinfoId != null) {
            stmt.bindLong(5, attrinfoId);
        }
    }

    @Override
    protected void attachEntity(PickList entity) {
    ...
    public PickList readEntity(Cursor cursor, int offset) {
        PickList entity = new PickList( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4) // attrinfoId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, PickList entity, int offset) {
        ...
        entity.setAttrinfoId(cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4));
     }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getAttributeInfoEntityDao().getAllColumns());
            builder.append(" FROM PICK_LIST T");
            builder.append(" LEFT JOIN ATTRIBUTE_INFO_ENTITY T0 ON T.'ATTRINFO_ID'=T0.'_id'");
            builder.append(' ');
    ...
    protected PickList loadCurrentDeep(Cursor cursor, boolean lock) {
        PickList entity = loadCurrent(cursor, 0, lock);
    ...
    public PickList loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<PickList> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<PickList> list = new ArrayList<PickList>(count);
    ...
    protected List<PickList> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<PickList> queryDeep(String where, String... selectionArg) {
