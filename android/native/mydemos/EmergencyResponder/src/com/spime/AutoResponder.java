...
public class AutoResponder extends Activity {
	...
	public static final String alarmAction = "com.spime.emergencyresponder.AUTO_RESPONSE_EXPIRED";
	...
	private void updateUIFromPreferences() {
		...
		boolean autoRespond = sp.getBoolean(
				getString(R.string.autoRespondPref), false);
		String respondText = sp.getString(getString(R.string.responseTextPref),
				"");
		boolean includeLoc = sp.getBoolean(
				getString(R.string.includeLocationPref), false);
	...
	protected void onPause() {
		// TODO Auto-generated method stub
	    unregisterReceiver(stopAutoResponderReceiver);
		super.onPause();
	}
	private void setAlarm(int respondForIndex) {
		...
		if (respondForIndex < 1)
			...
			// Otherwise find the length of time represented by the selection
			...
			lTime = lTime + respondFor * 1000 * 60;
			// Set the alarm.
			alarms.set(AlarmManager.RTC_WAKEUP, lTime, intentToFire);
		}
