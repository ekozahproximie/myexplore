...
public class MobileLocationDemoActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * Setup a listener for the GetPositionButton. When pressing this button
		 * the cell info is sent to the server and hopefully we will get a
		...
		try {
			...
			if (data != null) {
				try {
					...
					((TextView) findViewById(R.id.position_longitude))
							.setText("Longitude: "
									+ position.getDouble("longitude"));
					((TextView) findViewById(R.id.position_latitude))
							.setText("Latitude: "
									+ position.getDouble("latitude"));
					((TextView) findViewById(R.id.position_name))
							.setText("Name: " + position.getString("name"));
					((TextView) findViewById(R.id.position_accuracy))
							.setText("Accuracy: "
