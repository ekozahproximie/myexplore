...
public class LogViewer extends ListActivity{
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		final AlertDialog.Builder builder = new AlertDialog.Builder(LogViewer.this);
	...
	private class LogStringAdaptor extends ArrayAdapter<String>{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if(null == view)
			{
				LayoutInflater vi = (LayoutInflater)LogViewer.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
