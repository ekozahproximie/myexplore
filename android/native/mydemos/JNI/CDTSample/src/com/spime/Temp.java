...
//
//    /**
//     * Returns an instance of Temp instance for adding new contact
//     * to the platform contacts provider.
//     * 
//     * @param context the Authenticator Activity context
//     * @param userId the userId of the sample SyncAdapter user object
//     * @param accountName the username of the current login
//     * @return instance of Temp
//     */
//    public static Temp createNewContact(Context context,
//        int userId, String accountName, BatchOperation batchOperation) {
//        return new Temp(context, userId, accountName,
//            batchOperation);
//    }
//
//    /**
//     * Returns an instance of Temp for updating existing contact in
...
//     * @return instance of Temp
//     */
//    public static Temp updateExistingContact(Context context,
//        long rawContactId, BatchOperation batchOperation) {
//        return new Temp(context, rawContactId, batchOperation);
//    }
//
//    public Temp(Context context, BatchOperation batchOperation) {
...
//    }
//
//    public Temp(Context context, int userId, String accountName,
...
//    }
//
//    public Temp(Context context, long rawContactId,
//        BatchOperation batchOperation) {
//        this(context, batchOperation);
//        mIsNewContact = false;
...
//     * @return instance of Temp
//     */
//    public Temp addName(String firstName, String lastName) {
//        mValues.clear();
...
//     * @return instance of Temp
//     */
//    public Temp addEmail(String email) {
//        mValues.clear();
...
//     * @return instance of Temp
//     */
//    public Temp addPhone(String phone, int phoneType) {
//        mValues.clear();
...
//     * @return instance of Temp
//     */
//    public Temp addProfileAction(long userId) {
//        mValues.clear();
//        if (userId != 0) {
...
//     * @return instance of Temp
//     */
//    public Temp updateEmail(String email, String existingEmail,
//        Uri uri) {
...
//     * @return instance of Temp
//     */
//    public Temp updateName(Uri uri, String existingFirstName,
//        String existingLastName, String firstName, String lastName) {
//        Log.i("Temp", "ef=" + existingFirstName + "el="
...
//     * @return instance of Temp
//     */
//    public Temp updatePhone(String existingNumber, String phone,
//        Uri uri) {
...
//     * @return instance of Temp
//     */
//    public Temp updateProfileAction(Integer userId, Uri uri) {
//        mValues.clear();
//        mValues.put(SampleSyncAdapterColumns.DATA_PID, userId);
//        addUpdateOp(uri);
//        return this;
