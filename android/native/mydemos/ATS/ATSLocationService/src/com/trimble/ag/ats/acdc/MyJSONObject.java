...
public class MyJSONObject extends JSONObject {
	...
	public int getInt(String name) throws JSONException {
        ...
        public double getDouble(String name,final double dDefaultValue) throws JSONException {
                String stValue = getString(name);
	...
	public MyJSONArray getJSONArray(String name) throws JSONException {
	   ...
	   MyJSONArray  myJsonArray =null;
        ...
        public MyJSONObject getJSONObject_Optional(String name) throws JSONException {
              ...
              name=getNon_CamelCaseString(name);
                    try{
                      final JSONObject jsonObject2 =super.getJSONObject(name);
                       ...
                       //ignore
                       Log.e(LOG, "no value for key:"+name);
                    }
           }
        return jsonObject;
        }
	...
	private boolean isValueNull(final String stValue){
           
           boolean isValid = true;
           if(stValue == null || stValue.equalsIgnoreCase(NULL_VALUE)){
              isValid = false;
           }
