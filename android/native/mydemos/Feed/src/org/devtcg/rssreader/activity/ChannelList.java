...
private HashMap< Long, String> channelList = new HashMap<Long, String>();
...
//    };
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
    	...
    	menu.add(0,INSERT_ID,0, "New Channel").setShortcut('3', 'a');
...
//          edit.setShortcut(KeyEvent.KEYCODE_1, 0, KeyEvent.KEYCODE_E);
			...
			menu.add(Menu.CATEGORY_ALTERNATIVE, DELETE_ID,0, "Delete Channel");
			//setShortcut(KeyEvent.KEYCODE_2,  KeyEvent.KEYCODE_D);

    		//menu.addSeparator(Menu.CATEGORY_ALTERNATIVE, 0);
...
//    	}
		...
		int i=getContentResolver().delete(RSSReader.Posts.CONTENT_URI,
    	  "channel_id=?", new String[] { String.valueOf(channelId) });
		System.out.println(i);
		//mCursor.deleteRow();
    }
    private final long getSelectionRowID(){
    	return channelList.keySet().iterator().next();
    }
...
//    		return;
    	...
    	channelList.put(channelId, rssurl);
